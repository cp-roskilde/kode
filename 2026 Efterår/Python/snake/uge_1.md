...
Vores funktion skal have 2 input - _screen_ og _score_ (variablernes navne er ikke vigtig, sålænge det er noget, som giver mening - disse variabelnavne bliver KUN brugt, i selve funktionen).
...
Og den variabel, vi vil formatere samt selve formateringen skal stå i ***"{}"***
